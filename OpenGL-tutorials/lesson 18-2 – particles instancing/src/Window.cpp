...
void Window::Run()
{
    ...
    GLuint programID = LoadShaders(
        "../lesson 18-2 – particles instancing/VertexShader.glsl",
        "../lesson 18-2 – particles instancing/FragmentShader.glsl"
    );
    // Vertex shader.
    ...
    GLuint texture = loadDDS("../lesson 18-2 – particles instancing/particle.dds");
    ...
    do
    {
        ...
        for(int i = 0; i < newparticles; i++)
        {
            ...
            ParticlesContainer[particleIndex].pos = glm::vec3(20.f, -1.0f, 1.34193f);
